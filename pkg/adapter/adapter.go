...
import (
	...
	"github.com/npanel-dev/NPanel-backend/pkg/adapter/clash"
	"github.com/npanel-dev/NPanel-backend/pkg/adapter/general"
	"github.com/npanel-dev/NPanel-backend/pkg/adapter/loon"
	"github.com/npanel-dev/NPanel-backend/pkg/adapter/proxy"
	"github.com/npanel-dev/NPanel-backend/pkg/adapter/quantumultx"
	"github.com/npanel-dev/NPanel-backend/pkg/adapter/shadowrocket"
	"github.com/npanel-dev/NPanel-backend/pkg/adapter/singbox"
	"github.com/npanel-dev/NPanel-backend/pkg/adapter/surfboard"
	"github.com/npanel-dev/NPanel-backend/pkg/adapter/surge"
	"github.com/npanel-dev/NPanel-backend/pkg/adapter/v2rayn"
)
